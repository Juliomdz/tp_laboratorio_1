...
static Node* getNode(LinkedList* this, int nodeIndex)
{
  ...
  if(this != NULL && nodeIndex >= 0 && nodeIndex < ll_len(this)) //todo <= o solo <?
  {
...
/** \brief Devuelve el puntero al elemento del indice correspondiente
 *
 * \param this LinkedList* Puntero a la lista
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
  ...
  void* pElement;
  void* pElement2;
  int criterio; // 1= Orden Creciente. 0= Orden Decreciente.
  int flagOrden = 1;
